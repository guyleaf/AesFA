...
class Config:
    ...
    file_n = "main"
    log_dir = "./log/" + file_n
    ckpt_dir = os.path.expanduser("~/data/checkpoints/AesFA")
    ...
    if phase == "test":
        ...
        test_style_size = 256
        content_dir = os.path.expanduser("~/data/Weather/Weather_Anti_UAV/backgrounds")
        style_dir = os.path.expanduser("~/data/Weather/Weather_Anti_UAV/backgrounds")
